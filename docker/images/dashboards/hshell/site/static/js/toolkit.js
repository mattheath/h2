require=(function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);throw new Error("Cannot find module '"+o+"'")}var f=n[o]={exports:{}};t[o][0].call(f.exports,function(e){var n=t[o][1][e];return s(n?n:e)},f,f.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({"lgiFZk":[function(require,module,exports){
module.exports = jQuery;

},{}],"jquery":[function(require,module,exports){
module.exports=require('lgiFZk');
},{}],"q":[function(require,module,exports){
module.exports=require('iLjjjt');
},{}],"iLjjjt":[function(require,module,exports){
module.exports = Q;

},{}],"uri/URI":[function(require,module,exports){
module.exports=require('XNEX9x');
},{}],"XNEX9x":[function(require,module,exports){
module.exports = URI;

},{}],"toolkit/Cookie/Manager":[function(require,module,exports){
module.exports=require('x8mgB+');
},{}],"x8mgB+":[function(require,module,exports){
var Events = require('../Mixin/Events');
module.exports = function (documentAdapter) {
    var manager = this;
    Events.mixin(this);
    ...
    this.set = function (key, value, expires) {
        ...
        if (expires) {
            if (!(expires instanceof Date))
                expires = new Date(Date.now() + expires * 3600 * 1000);
    ...
    this.get = function (key) {
        var name = key + '=', cookieArr = documentAdapter.cookie.split(';'), i, c;
...
},{"../Mixin/Events":"DtsafZ"}],"BdvwOQ":[function(require,module,exports){
module.exports = function () {
    var value = '';
    function getCookieStringByKey(key) {
        var parts = value.split(';'), i, part, reservedKeys = [
                'expires',
                'path',
                'domain',
                'secure'
    ...
    function getCookieObjectByKey(key) {
        var cookieString = getCookieStringByKey(key), cookieObject = {};
        if ('' === cookieString) {
            return;
        }
    ...
    function shouldExpireCookie(cookieString) {
        var params = cookieString.split(';'), i, param, now = new Date();
    ...
    this.__defineSetter__('cookie', function (newCookieString) {
        var params = newCookieString.split(';'), newCookieKey = params[0].trim().split('=').shift();
...
},{}],"toolkit/CookieMock":[function(require,module,exports){
module.exports=require('BdvwOQ');
},{}],"5JD56o":[function(require,module,exports){
...
Elasticride.prototype.getCustomerURL = function (customerId) {
    ...
    return environment && 'https://elasticride.com/customers/' + environment + '/view/' + encodeURIComponent(customerId);
};
module.exports = Elasticride;
},{"./Environment":"i8Xb6F"}],"toolkit/Elasticride":[function(require,module,exports){
module.exports=require('5JD56o');
},{}],"i8Xb6F":[function(require,module,exports){
...
Environment.fromApiUrl = function (url) {
    return new this(function () {
        ...
        if (host.match('live') || host.match('lve') || host == 'api2.elasticride.com')
            return 'lve';
        if (host.match('stg'))
            return 'stg';
        if (host.match('tst'))
...
Environment.prototype.toElasticride = function () {
    if (this._environment == 'lve')
        return 'production';
    if (this._environment == 'stg')
        return 'staging';
    if (this._environment == 'tst')
        return 'development';
};
module.exports = Environment;
},{"uri/URI":"XNEX9x"}],"toolkit/Environment":[function(require,module,exports){
module.exports=require('i8Xb6F');
},{}],"toolkit/H1/BaseAPI":[function(require,module,exports){
module.exports=require('m5krM1');
},{}],"m5krM1":[function(require,module,exports){
var Events = require('../Mixin/Events'), Session = require('../H2/Session');
...
},{"../H2/Session":"bKZ3u2","../Mixin/Events":"DtsafZ"}],"toolkit/H1/CustomerAPI":[function(require,module,exports){
module.exports=require('OZ95yK');
},{}],"OZ95yK":[function(require,module,exports){
var Utils = require('../H1/Utils'), BaseAPI = require('../H1/BaseAPI'), Error = require('../H1/Errors/CustomerAPIError'), $ = require('jquery'), Q = require('q');
...
CustomerAPI.prototype.call = function (params) {
    var endpoint = params.endpoint || '', method = params.method || 'post';
    return Q($.ajax({
        method: method,
        url: this.getUrl(endpoint),
        data: params.data
    })).catch(function (xhr) {
        var response, errorParams = {
                service: 'customer',
...
CustomerAPI.prototype.getUrl = function (endpoint) {
    var url = this._baseURL + '/v1/' + endpoint, sessionId = this._session.getId();
    if (!sessionId) {
        return url;
    }
...
},{"../H1/BaseAPI":"m5krM1","../H1/Errors/CustomerAPIError":"fElFN2","../H1/Utils":"r7fWI+","jquery":"lgiFZk","q":"iLjjjt"}],"fElFN2":[function(require,module,exports){
'use strict';
module.exports = function (params) {
    ...
    this.isAccessDenied = function () {
        return this.code === 'hailo.webservice.authentication.notAuthenticated' || this.code === 5;
    };
};
},{}],"toolkit/H1/Errors/CustomerAPIError":[function(require,module,exports){
module.exports=require('fElFN2');
},{}],"x2LHHY":[function(require,module,exports){
'use strict';
module.exports = function (params) {
    this.code = params.code;
    this.message = params.message;
...
},{}],"toolkit/H1/Errors/ToolsAPIError":[function(require,module,exports){
module.exports=require('x2LHHY');
},{}],"toolkit/H1/ToolsAPI":[function(require,module,exports){
module.exports=require('NyYZjk');
},{}],"NyYZjk":[function(require,module,exports){
var Utils = require('../H1/Utils'), BaseAPI = require('../H1/BaseAPI'), Error = require('../H1/Errors/ToolsAPIError'), $ = require('jquery'), Q = require('q');
...
ToolsAPI.prototype.getUrl = function (endpoint) {
    var url = this._baseURL + '/' + endpoint, sessionId = this._session.getId();
    if (!sessionId) {
        return url;
    }
...
},{"../H1/BaseAPI":"m5krM1","../H1/Errors/ToolsAPIError":"x2LHHY","../H1/Utils":"r7fWI+","jquery":"lgiFZk","q":"iLjjjt"}],"toolkit/H1/Utils":[function(require,module,exports){
module.exports=require('r7fWI+');
},{}],"r7fWI+":[function(require,module,exports){
var Utils = {
...
},{}],"toolkit/H2/CallAPI":[function(require,module,exports){
module.exports=require('R71Zvo');
},{}],"R71Zvo":[function(require,module,exports){
var Events = require('../Mixin/Events'), Error = require('./CallAPI/Error'), Session = require('./Session'), _ = require('../vendor/lodash-2.4.1'), $ = require('jquery'), Q = require('q');
var validRegions = [
        'eu-west-1',
        'us-east-1'
    ];
...
var API = function (params) {
    ...
    this._timeout = params._timeout || 10 * 1000;
    this.setSession(Session.createAnonymous());
...
API.prototype.addErrorHandler = function (handler) {
    ...
    this.onError = function (error) {
        return Q.reject(error).catch(previousHandler).catch(handler);
    };
};
...
API.prototype._handleSessionExpiry = function () {
    ...
    var timeoutId;
    this.on('changeSession', function () {
        if (this.getSession() === handledSession)
            return;
...
module.exports = API;
},{"../Mixin/Events":"DtsafZ","../vendor/lodash-2.4.1":"Hb1bim","./CallAPI/Error":"vL681Q","./Session":"bKZ3u2","jquery":"lgiFZk","q":"iLjjjt"}],"toolkit/H2/CallAPI/Error":[function(require,module,exports){
module.exports=require('vL681Q');
},{}],"vL681Q":[function(require,module,exports){
var Q = require('q');
var APIError = function (params) {
    ...
    try {
        ...
        this.message = params.xhr.status ? 'Error ' + params.xhr.status : 'Network error or fetch termination (' + params.xhr.statusText + ')';
        if (responseBody)
            this.message += '\n\n' + responseBody;
    }
...
APIError.prototype._isUnauthenticatedError = function () {
    ...
    return new LoginService(api).sessionIsAuthenticated(this.api.getSession()).then(function (isAuthenticated) {
        return !isAuthenticated;
    });
};
module.exports = APIError;
},{"../CallAPI":"R71Zvo","../Service/Login":"pKqxoX","q":"iLjjjt"}],"toolkit/H2/Service/Driver":[function(require,module,exports){
module.exports=require('k2QZAh');
},{}],"k2QZAh":[function(require,module,exports){
var _ = require('../../vendor/lodash-2.4.1'), ProfileService = require('./Profile'), Q = require('q');
...
Service.prototype.getSchema = function (id) {
    return new ProfileService(this._api).getSchema({ schemaId: this.getSchemaIdFromDriverId(id) }).then(function (response) {
        response.schema.fields = ProfileService.sortSchemaFields(response.schema.fields);
        return response.schema;
    });
};
Service.prototype.getSchemaIdFromDriverId = function (id) {
    return 'DRIVER:' + this._getHob(id);
};
...
Service.prototype.moderateChanges = function (params) {
    return this._api.call('com.hailocab.service.driver', params.action + 'change', {
        ...
        moderatorId: this._api.getSession().getUsername(),
...
Service.prototype.getPendingChanges = function (request) {
    ...
    return this._api.call('com.hailocab.service.driver', 'getpendingchanges', request).then(function (response) {
        response.drivers = (response.drivers || []).map(function (driver) {
            driver.changes = service._removeChangesNotInSchema(driver.changes, response.schema);
            return driver;
...
Service.prototype._getHob = function (driverId) {
    ...
    if (!matches)
        throw new Error('Unknown driver ID format for \'' + driverId + '\'');
    return matches[0];
};
module.exports = Service;
},{"../../vendor/lodash-2.4.1":"Hb1bim","./Profile":"2tDezu","q":"iLjjjt"}],"toolkit/H2/Service/DriverLicense":[function(require,module,exports){
module.exports=require('GlVQhU');
},{}],"GlVQhU":[function(require,module,exports){
var Service = function (api) {
    this._api = api;
};
Service.prototype.search = function (request) {
    return this._api.call('com.hailocab.service.driver-license', 'search', request).then(function (response) {
        response.licenses = response.licenses || [];
        return response;
    });
};
module.exports = Service;
},{}],"9zamgE":[function(require,module,exports){
...
OrganizationsService.prototype = {
    ...
    read: function (id) {
        return this.h2api.call(service, 'read_organization', { id: id });
    },
    ...
    updateOrganization: function (organization) {
        return this.h2api.call(service, 'update_organization', { organization: organization });
    },
...
},{}],"toolkit/H2/Service/H4bOrganizations":[function(require,module,exports){
module.exports=require('9zamgE');
},{}],"+QxP88":[function(require,module,exports){
var Service = function (api) {
    this._api = api;
};
Service.prototype.getHobs = function (request) {
    return this._api.call('com.hailocab.service.hob', 'list', request || {}).then(function (response) {
        var hobs = response.hobs || [];
        return hobs;
    });
};
Service.prototype.getHobConfig = function (hob) {
    return this._api.call('com.hailocab.service.hob', 'config', { code: hob }).then(function (hConfig) {
        return hConfig;
    });
};
module.exports = Service;
},{}],"toolkit/H2/Service/Hob":[function(require,module,exports){
module.exports=require('+QxP88');
},{}],"toolkit/H2/Service/IDGen":[function(require,module,exports){
module.exports=require('nm1yda');
},{}],"nm1yda":[function(require,module,exports){
var Service = function (api) {
    this._api = api;
};
Service.prototype.cruftflake = function () {
    return this._api.call('com.hailocab.service.idgen', 'cruftflake').then(function (response) {
...
module.exports = Service;
},{}],"toolkit/H2/Service/Login":[function(require,module,exports){
module.exports=require('pKqxoX');
},{}],"pKqxoX":[function(require,module,exports){
var ApiError = require('../CallAPI/Error'), Session = require('../Session'), AuthResponse = require('./Login/AuthResponse'), Q = require('q');
var Service = function (api) {
    this._api = api;
};
Service.prototype.auth = function (request, password) {
    ...
    return this._api.call('com.hailocab.service.login', 'auth', request).then(function (response) {
...
Service.prototype.readSession = function (session) {
    return this._api.call('com.hailocab.service.login', 'readsession', { sessId: this._getSessionId(session) }).then(function (response) {
...
Service.prototype.sessionIsAuthenticated = function (session) {
    ...
    if (!sessionId)
        return Q(false);
    return this.readSession(sessionId).then(function (session) {
...
Service.prototype.logout = function () {
    var service = this;
    return this._api.call('com.hailocab.service.login', 'deletesession', { sessId: this._api.getSession().getId() }).then(function () {
        service._api.setSession(null);
    });
};
...
module.exports = Service;
},{"../CallAPI/Error":"vL681Q","../Session":"bKZ3u2","./Login/AuthResponse":"lKmp+u","q":"iLjjjt"}],"lKmp+u":[function(require,module,exports){
...
module.exports = function (rawResponse) {
...
},{"../../Session":"bKZ3u2"}],"toolkit/H2/Service/Login/AuthResponse":[function(require,module,exports){
module.exports=require('lKmp+u');
},{}],"toolkit/H2/Service/Profile":[function(require,module,exports){
module.exports=require('2tDezu');
},{}],"2tDezu":[function(require,module,exports){
var _ = require('../../vendor/lodash-2.4.1'), DriverLicenseService = require('./DriverLicense'), Q = require('q');
var Service = function (api) {
    this._api = api;
};
Service.sortSchemaFields = function (fields) {
    fields = _.sortBy(fields, 'name');
    return function getChildren(parentName) {
        return fields.filter(function (field) {
            return field.belongsTo == parentName;
...
Service.prototype.getSchema = function (request) {
    return this._api.call('com.hailocab.service.profile', 'getschema', request).then(function (response) {
...
module.exports = Service;
},{"../../vendor/lodash-2.4.1":"Hb1bim","./DriverLicense":"GlVQhU","q":"iLjjjt"}],"toolkit/H2/Service/Virtue":[function(require,module,exports){
module.exports=require('IQZ7aH');
},{}],"IQZ7aH":[function(require,module,exports){
var _ = require('../../vendor/lodash-2.4.1'), Q = require('q'), Environment = require('../../Environment');
var defaultOpts = {
        retry: 5000,
        host: false,
        port: 443,
...
function doConnect(virtue) {
    ...
    virtue.conn.onclose = function (evt) {
        ...
        if (virtue.opts.reconnect) {
            virtue.log('[Virtue-Client] Connection closed. Reconnection in ' + virtue.opts.retry + ' [url=' + virtue.connectStr + ']');
    ...
    virtue.conn.onmessage = function (evt) {
        ...
        if (virtue.msgHandlers[msg.action]) {
            ...
            virtue.log('[Virtue-Client] No handler for message [action=' + msg.action + ', message=' + msg + ']');
        }
    };
}
...
Virtue.prototype.updateRegion = function (newRegion) {
    if (newRegion && this.opts.region !== newRegion) {
        ...
        this.connectStr = (this.opts.secure ? 'wss://' : 'ws://') + host + ':' + this.opts.port;
        this.log('[Virtue-Client] Switching to different region [new-region= ' + newRegion + ']: ' + this.connectStr);
        if (this.conn) {
...
Virtue.prototype.connect = function () {
    var host = this.opts.host ? this.opts.host : getVirtueURL(this._api, this.opts.region);
    this.connectStr = (this.opts.secure ? 'wss://' : 'ws://') + host + ':' + this.opts.port;
    this.log('[Virtue-Client] Connecting to virtue web sockets server: ' + this.connectStr);
    doConnect(this);
};
...
},{"../../Environment":"i8Xb6F","../../vendor/lodash-2.4.1":"Hb1bim","q":"iLjjjt"}],"toolkit/H2/Service/WebDiscovery":[function(require,module,exports){
module.exports=require('bscWgT');
},{}],"bscWgT":[function(require,module,exports){
var Webapp = require('../../Webapp/Repository/Webapp'), Q = require('q');
...
Service.prototype.webapps = function () {
    return this._api.call('com.hailocab.service.web-discovery', 'webapps', {}).then(function (r) {
...
Service.prototype.webapp = function (id) {
    return this._api.call('com.hailocab.service.web-discovery', 'webapps', { 'name': id }).then(function (r) {
        if (r.webapps && r.webapps.length > 0) {
            return getWebapp(r.webapps[0]);
        }
        return Q.reject('Webapp not found');
    });
};
module.exports = Service;
},{"../../Webapp/Repository/Webapp":"lEw34U","q":"iLjjjt"}],"4NwQSh":[function(require,module,exports){
var Webapp = require('../../Webapp/Repository/Webapp'), Q = require('q');
var getWebapp = function (r) {
    return new Webapp({
        id: r.id || '',
...
Service.prototype.search = function () {
    return this._api.call('com.hailocab.service.web-provisioning', 'search', {}).then(function (r) {
...
Service.prototype.get = function (id) {
    return this._api.call('com.hailocab.service.web-provisioning', 'search', { 'name': id }).then(function (r) {
...
module.exports = Service;
},{"../../Webapp/Repository/Webapp":"lEw34U","q":"iLjjjt"}],"toolkit/H2/Service/WebProvisioning":[function(require,module,exports){
module.exports=require('4NwQSh');
},{}],"9reNlP":[function(require,module,exports){
var Warning = require('../../Warning'), IDGenService = require('./IDGen'), Q = require('q');
    ...
    return this._call('read', request).then(function (response) {
        ...
        response.zone = (response.zone || []).map(function (zone) {
            try {
                ...
                errors.push(new Error('Could not parse geo data for zone \'' + zone.name + '\' from \'' + zone.geoData + '\'. '));
                zone.geoData = null;
            }
            try {
                zone.metaData = JSON.parse(zone.metaData);
            } catch (error) {
                errors.push(new Error('Could not parse metadata for zone \'' + zone.name + '\' from \'' + zone.metaData + '\'. '));
                zone.metaData = {};
            }
            return zone;
        });
...
Zoning.prototype.create = function (zone) {
    ...
    return Q().then(function () {
        if (!zone.id) {
            return new IDGenService(service._api).cruftflake().then(function (response) {
                zone.id = response.id;
            });
        }
    }).then(function () {
...
},{"../../Warning":"r9GyYD","./IDGen":"nm1yda","q":"iLjjjt"}],"toolkit/H2/Service/Zoning":[function(require,module,exports){
module.exports=require('9reNlP');
},{}],"bKZ3u2":[function(require,module,exports){
...
},{}],"toolkit/H2/Session":[function(require,module,exports){
module.exports=require('bKZ3u2');
},{}],"toolkit/H2/Session/CookieStorage":[function(require,module,exports){
module.exports=require('gCvGi5');
},{}],"gCvGi5":[function(require,module,exports){
var CookieManager = require('../../Cookie/Manager'), Session = require('../Session'), URI = require('uri/URI');
var key = 'session';
module.exports = function (callAPI, documentAdapter) {
    ...
    callAPI.on('changeSession', function () {
        storage._setSession(callAPI.getSession());
    });
    this._restore();
};
},{"../../Cookie/Manager":"x8mgB+","../Session":"bKZ3u2","uri/URI":"XNEX9x"}],"toolkit/Mixable":[function(require,module,exports){
module.exports=require('qrK+qT');
},{}],"qrK+qT":[function(require,module,exports){
module.exports = {
...
},{}],"DtsafZ":[function(require,module,exports){
...
},{"../Mixable":"qrK+qT"}],"toolkit/Mixin/Events":[function(require,module,exports){
module.exports=require('DtsafZ');
},{}],"r9GyYD":[function(require,module,exports){
...
},{}],"toolkit/Warning":[function(require,module,exports){
module.exports=require('r9GyYD');
},{}],"toolkit/Webapp":[function(require,module,exports){
module.exports=require('JcCtFm');
},{}],"JcCtFm":[function(require,module,exports){
var API = require('./H2/CallAPI'), Config = require('./Webapp/Config'), ErrorHandler = require('./Webapp/ErrorHandler'), GoogleAnalytics = require('./Webapp/GoogleAnalytics'), LoginWebapp = require('./Webapp/Login'), Q = require('q');
...
},{"./H2/CallAPI":"R71Zvo","./Webapp/Config":"1Uv4n3","./Webapp/ErrorHandler":"zh4Ksa","./Webapp/GoogleAnalytics":"WV+KMW","./Webapp/Login":"Sz0veI","q":"iLjjjt"}],"toolkit/Webapp/Config":[function(require,module,exports){
module.exports=require('1Uv4n3');
},{}],"1Uv4n3":[function(require,module,exports){
var $ = require('jquery'), Q = require('q');
var defaultConfig = {
        'environment': {
...
module.exports = function () {
    ...
    return Q($.when($.getJSON('/environment.json'), $.getJSON('/config.json')).then(function (env, cfg) {
        return {
            'environment': env[0],
            'config': cfg[0]
        };
...
},{"jquery":"lgiFZk","q":"iLjjjt"}],"toolkit/Webapp/ErrorHandler":[function(require,module,exports){
module.exports=require('zh4Ksa');
},{}],"zh4Ksa":[function(require,module,exports){
var addErrorListener = function (windowAdapter, listener) {
    ...
    windowAdapter.onerror = function () {
        ...
        var listeners = [];
        if (originalListener)
            listeners.push(originalListener);
        listeners.push(listener);
        return listeners.map(function (listener) {
            return listener.apply(null, onErrorArguments);
        }).some(function (preventDefaultHandler) {
...
module.exports = function (params) {
    ...
    addErrorListener(params.window, function (message, file, line, column, error) {
        ...
        if (params.api) {
            params.api.call('com.hailocab.service.web-events', 'log', {
                level: 'error',
...
},{}],"toolkit/Webapp/GoogleAnalytics":[function(require,module,exports){
module.exports=require('WV+KMW');
},{}],"WV+KMW":[function(require,module,exports){
var Events = require('../Mixin/Events');
...
},{"../Mixin/Events":"DtsafZ"}],"Sz0veI":[function(require,module,exports){
var Api = require('../H2/CallAPI'), SessionStorage = require('../H2/Session/CookieStorage'), LoginService = require('../H2/Service/Login'), Overlay = require('./Login/Overlay'), Q = require('q');
var Webapp = function (params) {
    if (params instanceof Api)
        params = { api: params };
    this.api = params.api;
...
Webapp.prototype.login = function () {
    var webapp = this;
    return new LoginService(this.api).sessionIsAuthenticated().then(function (isAuthenticated) {
        if (isAuthenticated) {
            return;
        }
...
},{"../H2/CallAPI":"R71Zvo","../H2/Service/Login":"pKqxoX","../H2/Session/CookieStorage":"gCvGi5","./Login/Overlay":"3COgOT","q":"iLjjjt"}],"toolkit/Webapp/Login":[function(require,module,exports){
module.exports=require('Sz0veI');
},{}],"3COgOT":[function(require,module,exports){
var Events = require('../../Mixin/Events'), Repository = require('../Repository');
...
Overlay.prototype.show = function () {
    ...
    new Repository(this._webapp.api).get('login-webapp').then(function (loginWebapp) {
        if (!overlay._element)
            return;
        overlay._element.src = loginWebapp.getUrl() + '?mechanism=' + encodeURIComponent(overlay._webapp.mechanism) + '&application=' + encodeURIComponent(overlay._webapp.application) + '&api-url=' + encodeURIComponent(overlay._webapp.api.getBaseURL());
...
},{"../../Mixin/Events":"DtsafZ","../Repository":"mNGfju"}],"toolkit/Webapp/Login/Overlay":[function(require,module,exports){
module.exports=require('3COgOT');
},{}],"mNGfju":[function(require,module,exports){
var _ = require('../vendor/lodash-2.4.1'), Environment = require('../Environment'), WebDiscovery = require('../H2/Service/WebDiscovery'), Webapp = require('./Repository/Webapp');
...
},{"../Environment":"i8Xb6F","../H2/Service/WebDiscovery":"bscWgT","../vendor/lodash-2.4.1":"Hb1bim","./Repository/Webapp":"lEw34U"}],"toolkit/Webapp/Repository":[function(require,module,exports){
module.exports=require('mNGfju');
},{}],"toolkit/Webapp/Repository/Webapp":[function(require,module,exports){
module.exports=require('lEw34U');
},{}],"lEw34U":[function(require,module,exports){
module.exports = function (params) {
    this.getId = function () {
        return params.id;
    };
...
},{}],"Hb1bim":[function(require,module,exports){
...
},{}],"toolkit/vendor/lodash-2.4.1":[function(require,module,exports){
module.exports=require('Hb1bim');
},{}]},{},[])
;